...
public class SubstractTest {
    ...
    @Test
    public void substracts_two_integers() {
    ...
    @Test
    public void substracts_first_double_second_integer() {
    ...
    @Test
    public void substracts_first_integer_second_double() {
    ...
    @Test
    public void substracts_two_double() {
