...
public class MultiplyTest {
    ...
    @Test
    public void multiplys_two_integers() {
    ...
    @Test
    public void multiplys_first_double_second_integer() {
    ...
    @Test
    public void multiplys_first_integer_second_double() {
    ...
    @Test
    public void multiplys_two_double() {
